...
extern void gotoLCD(char ligne, char colonne)
 {
    LATBbits.LB5 = 0;
     ...
     if(ligne == 0)
        lcdWrite(0x80 + colonne, COMMAND);
     else
       lcdWrite(0x80 + 0x40 + colonne, COMMAND);
 }
...
unsigned char CSSP1=0;
unsigned char READ=0;
unsigned char WRITE=0;
unsigned char testlecture;
unsigned char SSP1_ADD_ISR=0;
unsigned char SSP1_REG_ISR=0;
unsigned char SSP1_DATA_ISR=0;
...
void SSP1_Write (unsigned char SSP1_ADD, unsigned char SSP1_REG, unsigned char SSP1_DATA)
{
    CSSP1=0;
    READ=0;
    WRITE=1;
    SSP1_ADD_ISR=SSP1_ADD;
    SSP1_REG_ISR=SSP1_REG;
    SSP1_DATA_ISR=SSP1_DATA;
    SSP1CON2bits.SEN=1;
}

void SSP1_Read (unsigned char SSP1_ADD, unsigned char SSP1_REG)
{
    CSSP1=0;
    READ=1;
    WRITE=0;
...
void C2(unsigned long DUREE) {DUREE=DUREE/3.822; for (j=0; j<DUREE;j++) {LATAbits.LATA0=!LATAbits.LATA0; _delay((unsigned long)((3822)*(64000000/4000000.0)));} LATAbits.LATA0=0;}
void D2(unsigned long DUREE) {DUREE=DUREE/3.406; for (j=0; j<DUREE;j++) {LATAbits.LATA0=!LATAbits.LATA0; _delay((unsigned long)((3406)*(64000000/4000000.0)));} LATAbits.LATA0=0;}
void E2(unsigned long DUREE) {DUREE=DUREE/3.034; for (j=0; j<DUREE;j++) {LATAbits.LATA0=!LATAbits.LATA0; _delay((unsigned long)((3034)*(64000000/4000000.0)));} LATAbits.LATA0=0;}
void F2(unsigned long DUREE) {DUREE=DUREE/2.863; for (j=0; j<DUREE;j++) {LATAbits.LATA0=!LATAbits.LATA0; _delay((unsigned long)((2863)*(64000000/4000000.0)));} LATAbits.LATA0=0;}
void G2(unsigned long DUREE) {DUREE=DUREE/2.551; for (j=0; j<DUREE;j++) {LATAbits.LATA0=!LATAbits.LATA0; _delay((unsigned long)((2551)*(64000000/4000000.0)));} LATAbits.LATA0=0;}
void A2(unsigned long DUREE) {DUREE=DUREE/2.272; for (j=0; j<DUREE;j++) {LATAbits.LATA0=!LATAbits.LATA0; _delay((unsigned long)((2272)*(64000000/4000000.0)));} LATAbits.LATA0=0;}
void B2(unsigned long DUREE) {DUREE=DUREE/2.024; for (j=0; j<DUREE;j++) {LATAbits.LATA0=!LATAbits.LATA0; _delay((unsigned long)((2024)*(64000000/4000000.0)));} LATAbits.LATA0=0;}
void C3(unsigned long DUREE) {DUREE=DUREE/1.91; for (j=0; j<DUREE;j++) {LATAbits.LATA0=!LATAbits.LATA0; _delay((unsigned long)((1910)*(64000000/4000000.0)));} LATAbits.LATA0=0;}
void D3(unsigned long DUREE) {DUREE=DUREE/1.702; for (j=0; j<DUREE;j++) {LATAbits.LATA0=!LATAbits.LATA0; _delay((unsigned long)((1702)*(64000000/4000000.0)));} LATAbits.LATA0=0;}
void E3(unsigned long DUREE) {DUREE=DUREE/1.517; for (j=0; j<DUREE;j++) {LATAbits.LATA0=!LATAbits.LATA0; _delay((unsigned long)((1517)*(64000000/4000000.0)));} LATAbits.LATA0=0;}
void F3(unsigned long DUREE) {DUREE=DUREE/1.432; for (j=0; j<DUREE;j++) {LATAbits.LATA0=!LATAbits.LATA0; _delay((unsigned long)((1432)*(64000000/4000000.0)));} LATAbits.LATA0=0;}
void G3(unsigned long DUREE) {DUREE=DUREE/1.276; for (j=0; j<DUREE;j++) {LATAbits.LATA0=!LATAbits.LATA0; _delay((unsigned long)((1276)*(64000000/4000000.0)));} LATAbits.LATA0=0;}
void A3(unsigned long DUREE) {DUREE=DUREE/1.136; for (j=0; j<DUREE;j++) {LATAbits.LATA0=!LATAbits.LATA0; _delay((unsigned long)((1136)*(64000000/4000000.0)));} LATAbits.LATA0=0;}
void B3(unsigned long DUREE) {DUREE=DUREE/1.012; for (j=0; j<DUREE;j++) {LATAbits.LATA0=!LATAbits.LATA0; _delay((unsigned long)((1012)*(64000000/4000000.0)));} LATAbits.LATA0=0;}
void C4(unsigned long DUREE) {DUREE=DUREE/0.956; for (j=0; j<DUREE;j++) {LATAbits.LATA0=!LATAbits.LATA0; _delay((unsigned long)((956)*(64000000/4000000.0)));} LATAbits.LATA0=0;}
...
# 224 "2emeAlidar.c"
    ...
    C2(50); D2(50); E2(50); F2(50); G2(50); A2(50); B2(50);
    C3(50); D3(50); E3(50); F3(50); G3(50); A3(50); B3(50);
    C4(200);
    ...
    RC1IF=0; RC1IE=1; RC1IP=0;
    RC2IF=0; RC2IE=1; RC2IP=0;
...
void __attribute__((picinterrupt(("low_priority")))) myLowIsr(void)
{
    ...
    if (RC2IE&&RC2IF)
    {
        ...
        test=RC2REG;
        TX2REG=test;
        gotoLCD(1,9); lcdWrite((test/100)+0x30,DATA);
        gotoLCD(1,10); lcdWrite(((test%100)/10)+0x30,DATA);
        gotoLCD(1,11); lcdWrite((test%10)+0x30,DATA);
        C3(50);
        RC2IF=0;
    }
}
...
void __attribute__((picinterrupt(("high_priority")))) myHighIsr(void)
{
    if (IOCIF&&IOCIE)
    {
        ...
        if (IOCBF0==1) {tempsg=TMR1; TMR1=0; if ((PORTDbits.RD6&&PORTBbits.RB0)||(!PORTDbits.RD6&&!PORTBbits.RB0)) {tempsg=-tempsg;} IOCBF0=0;}
        if (IOCCF5==1) {tempsd=TMR5; TMR5=0; if ((PORTCbits.RC5&&!PORTCbits.RC4)||(!PORTCbits.RC5&&PORTCbits.RC4)) {tempsd=-tempsd;} IOCCF5=0;}
        IOCIF=0;
    }
    ...
    if (TMR6IF&&TMR6IE)
    {
       erreurg=consigneg-(87000/tempsg);
       ...
       pwmgc=pwmgc+127;
       CCPR2H=pwmgc;
       erreurd=-consigned-(87000/tempsd);
    ...
    if (SSP1IE&&SSP1IF)
    {
        if (WRITE&&!READ)
        {
            switch (CSSP1)
            {
                case 0 : SSP1BUF=(SSP1_ADD_ISR<<1); CSSP1=1; break;
                case 1 : SSP1BUF=SSP1_REG_ISR; CSSP1=2; break;
                case 2 : SSP1BUF=SSP1_DATA_ISR; CSSP1=3; break;
                case 3 : SSP1CON2bits.PEN=1; CSSP1=0; break;
            }
        }
        if (!WRITE&&READ)
        {
            switch (CSSP1)
            {
                case 0 : SSP1BUF=(SSP1_ADD_ISR<<1); CSSP1=1; break;
                case 1 : SSP1BUF=SSP1_REG_ISR; CSSP1=2; break;
                case 2 : SSP1CON2bits.SEN=1; CSSP1=3; break;
                case 3 : SSP1BUF=(SSP1_ADD_ISR<<1)+1; CSSP1=4; break;
                case 4 : SSP1CON2bits.RCEN=1; CSSP1=5; break;
                case 5 : SSP1CON2bits.PEN=1; SSP1_DATA_ISR=SSP1BUF; CSSP1=0; break;
            }
        }
        SSP1IF=0;
    }
...
unsigned char Get_ADC_CNYG (void) {LATAbits.LATA3=1; ADPCH=0b000010; _delay((unsigned long)((100)*(64000000/4000000.0))); ADGO=1; while (ADGO); LATAbits.LATA3=0; return ADRESH;}
unsigned char Get_ADC_CNYD (void) {LATEbits.LATE1=1; ADPCH=0b100000; _delay((unsigned long)((100)*(64000000/4000000.0))); ADGO=1; while (ADGO); LATEbits.LATE1=0; return ADRESH;}
