...
void __attribute__((picinterrupt(("high_priority")))) myHighIsr(void)
{
    if (IOCIF&&IOCIE)
    {
        ...
        {
            tempsg=TMR1; TMR1=0;
            if ((PORTDbits.RD6&&PORTBbits.RB0)||(!PORTDbits.RD6&&!PORTBbits.RB0)) {tempsg=-tempsg;}
            IOCBF0=0;
        }
        if (IOCCF5==1)
        {
            tempsd=TMR5; TMR5=0;
            if ((PORTCbits.RC5&&!PORTCbits.RC4)||(!PORTCbits.RC5&&PORTCbits.RC4)) {tempsd=-tempsd;}
            IOCCF5=0;
        }
        IOCIF=0;
    }
...
unsigned char Get_ADC_CNYG (void)
{
    LATAbits.LATA3=1;
    ADPCH=0b000010;
    _delay((unsigned long)((1)*(64000000/4000.0)));
...
unsigned char Get_ADC_CNYD (void)
{
    LATEbits.LATE1=1;
    ADPCH=0b100000;
    _delay((unsigned long)((1)*(64000000/4000.0)));
